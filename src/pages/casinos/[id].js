        ...
        <main>
          <div className="bg-white ">
            <div className="relative bg-gray-900">
              ...
              <div className="max-w-4xl mx-auto lg:max-w-7xl lg:px-8 xl:grid xl:grid-cols-2 xl:grid-flow-col-dense xl:gap-x-8">
                <div className="relative w-3/4 p-8 m-16 xl:col-start-1 xl:pb-24 text-grey-600 bg-white bg-opacity-75">
                      ...
                      <div className="flex items-center">
                        ...
                        <p className="text-xs">
                          ...
                          {item?.opening_hour?.gaming && (
                            <span className="ml-2"> Live Gaming from {getFriendlyTime(item?.opening_hour?.gaming)}</span>
                          )}
                        </p>
                      </div>
                    )}
